...
import pandera as pa  # Importa novamente pandera (parece duplicado)
from src.etl.transformar import transforma_dados  # Importa a função transforma_dados do módulo src.etl.transformar
from src.contrato import NovasMetricasClienteBase  # Importa a classe NovasMetricasClienteBase do módulo src.contrato
